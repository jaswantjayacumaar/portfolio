...
- **Hero**: an animated, simulated run of an SEM bidding console:
...
- **Research**: pulsar timing at Jodrell Bank and deep-learning
  gravitational-wave classification, with figures
